    ...
    <main>
        <section id="lewy">
            ...
            <section id="lewy-dolny">
                ...
                <!-- Skrypt 2 -->
                <?php
                $query = mysqli_query($connection, 'SELECT DISTINCT swinki.data_ur, swinki.miot, rasy.rasa FROM swinki LEFT JOIN rasy ON swinki.rasy_id = rasy.id WHERE swinki.rasy_id = 6;');
                ...
                <!-- Skrypt 3 -->
                <?php
                $query = mysqli_query($connection, 'SELECT swinki.imie, swinki.cena, swinki.opis FROM swinki WHERE swinki.rasy_id = 6;');
